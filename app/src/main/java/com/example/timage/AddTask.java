...
//    private int hour, minute;
    private EditText taskName, desc,date,month,year, time;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cat_id_taken = category_id_intent.getLongExtra("id of category", cat_id_taken);
...
//        datePicker = (DatePicker) findViewById(R.id.datePickerButton);
        ...
        date = (EditText) findViewById(R.id.dateDueinput);
        month = (EditText) findViewById(R.id.monthDueinput);
        year = (EditText) findViewById(R.id.yearDueinput);
        time = (EditText) findViewById(R.id.timeDueinput);
        ...
        addTask.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                db.insertTask(task_name, Integer.parseInt(task_date), Integer.parseInt(task_month), Integer.parseInt(task_year), task_time,task_desc,0, (int) cat_id_taken);
